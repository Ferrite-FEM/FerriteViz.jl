...
linear_face_cell(cell::Ferrite.Tetrahedron, local_face_idx::Int) =  Ferrite.Cell{3,3,1}(Ferrite.faces(cell)[local_face_idx])
linear_face_cell(cell::Ferrite.Hexahedron, local_face_idx::Int) = Ferrite.Quadrilateral3D(Ferrite.faces(cell)[local_face_idx])
linear_face_cell(cell::Ferrite.Cell{3,20,6}, local_face_idx::Int) = Ferrite.Quadrilateral3D(Ferrite.faces(cell)[local_face_idx])
